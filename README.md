...
- **It records its source in the `rollback_from` property.** This holds the name of the revision that was rolled back to, or — when that revision is unnamed — its version number.
